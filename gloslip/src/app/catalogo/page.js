  ...
  return (
    <div className="product-card" style={{ 
      ...
      <Link href={`/producto/${producto.id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
        <img src={producto.imagen} alt={producto.nombre} style={{ width: '100%', borderRadius: '12px', objectFit: 'cover', aspectRatio: '1/1' }} />
      </Link>
      ...
      <div style={{ marginTop: '15px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '10px' }}>
        ...
        <div style={{ 
          width: '22px', height: '22px', backgroundColor: producto.colorHex, 
...
export default function Catalogo() {
  ...
  let productosMostrados = listaProductos.filter((prod) => {
    ...
    const coincideColor = colorFiltro === 'todos' || prod.familiaColor === colorFiltro;
